...
const AssignVehiclesInfor: React.FC = () => {
          ...
          {fakeUsers ? (
            fakeUsers.map((el, index) => {
              return (
                ...
                >
                  <div className="flex gap-[7rem] items-center w-[50%]">
                  ...
                  <select className="border-gray-200 border-[1px] h-[3rem] text-2xl font-semibold">
                    <option>Suzuki 400kg Garbage Truck</option>
                    <option>Jac X150 1.300KG Garbage Truck</option>
                    <option>Hyundai HD260 20CBM Garbage Truck</option>
                    <option>Hino Hooklift Garbage Truck</option>
                  </select>
                  <button
                    onClick={() => {
...
export default AssignVehiclesInfor;
